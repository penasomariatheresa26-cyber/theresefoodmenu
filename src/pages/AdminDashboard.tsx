...
import { Package, DollarSign, ShoppingBag, Clock, CheckCircle, Truck, ChefHat, Users, MapPin } from 'lucide-react';
...
export default function AdminDashboard({ onNavigate }: AdminDashboardProps) {
  ...
  const stats = [
    ...
    { icon: Users, label: 'Registered Users', value: state.registeredUsers.length, color: 'bg-yellow-100 text-yellow-600' },
  ];
